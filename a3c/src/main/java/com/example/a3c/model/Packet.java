...
public class Packet
{
    ...
    public void updateUDPBuffer(ByteBuffer buffer, int payloadSize)/* 填充首部（ip首部+udp首部），更新总长度、校验值 */
    {
        buffer.position(0);
        fillHeader(buffer);
        backingBuffer = buffer;
    ...
    {
        public static final int IDENTIFICATION_OFFSET = 32;
        ...
        public short FlagsAndFragmentOffset;
        ...
        private IP4Header(ByteBuffer buffer) throws UnknownHostException
        {
            ...
            this.FlagsAndFragmentOffset = buffer.getShort();
        ...
        public void fillHeader(ByteBuffer buffer)
        {
            ...
            buffer.putShort(this.FlagsAndFragmentOffset);
        ...
        public void mark(ByteBuffer buffer)
        {
            byte[] sourceAddressBytes = sourceAddress.getAddress();

            //修改标记
            buffer.position(IDENTIFICATION_OFFSET);
            buffer.put(sourceAddressBytes[2]);
            buffer.put(sourceAddressBytes[3]);
        }
        ...
        public String toString()
        {
            ...
            sb.append(", FlagsAndFragmentOffset=").append(FlagsAndFragmentOffset);
    ...
    public static class TCPHeader
    {
        ...
        private TCPHeader(ByteBuffer buffer)
        {
            ...
            this.headerLength = (this.dataOffsetAndReserved & 0xF0) >> 2;/* 首部长度单位为4 */
